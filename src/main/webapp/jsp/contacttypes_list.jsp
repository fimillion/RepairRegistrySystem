...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#grid").jqGrid({
            ...
            colModel:[
                {name:'contactTypeId',index:'contactTypeId', width:55, editable:false, editoptions:{readonly:true, size:10}, hidden:true},
                {name:'contactTypeName',index:'contactTypeName', width:100, editable:true, editrules:{required:true}, editoptions:{size:10}},
