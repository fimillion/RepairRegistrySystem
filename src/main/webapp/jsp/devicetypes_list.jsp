...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#grid").jqGrid({
            url:'${pageContext.request.contextPath}/devicetypes/listing',
            editurl:'${pageContext.request.contextPath}/devicetypes/edit',
            datatype: 'json',
            mtype: 'POST',
            styleUI : 'Bootstrap',
